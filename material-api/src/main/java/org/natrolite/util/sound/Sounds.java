...
package org.natrolite.util.sound;

public final class Sounds {

  //SORTFIELDS:ON

  public static final Sound ENTITY_PLAYER_LEVELUP = new Sound("LEVEL_UP", "ENTITY_PLAYER_LEVELUP");

  public static final Sound BLOCK_NOTE_PLING = new Sound("NOTE_PLING", "BLOCK_NOTE_PLING");
